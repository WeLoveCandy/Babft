...
local MainLeft = Main:section({name = "General", side = "left", size = 40})
local MainRight = Main:section({name = "Items", side = "right", size = 125})

local Player = window:page({name = "Player"})
local PlayerLeft = Player:section({name = "Player", side = "left", size = 75})
local PlayerRight = Player:section({name = "Teleport", side = "right", size = 125})

local Misc = window:page({name = "Misc"})
local MiscLeft = Misc:section({name = "Misc", side = "left", size = 30})

local Settings = window:page({name = "Settings"})
local SetLeft = Settings:section({name = "Settings gui", side = "left", size = 100})
